...
public class AlbumDetailFragment extends Fragment implements AlbumDetailAdapter.AlbumDetailAdapterListener{
    ...
    public void onAttach(@NonNull Context context) {
        ...
        albumDetailListener = (AlbumDetailListener) context;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        albumDetailPlay.setOnClickListener((button -> {
            animateListContent();
            albumDetailListener.onAlbumTrackClickedListener(0, albumSongs, false);
        }));
        albumDetailShuffle.setOnClickListener((button) -> {
            animateListContent();
            albumDetailListener.onAlbumTrackClickedListener(0, albumSongs, true);
        });
    ...
    public void onItemClickListener(int position) {
        albumDetailListener.onAlbumTrackClickedListener(position, albumSongs, false);
    }
}
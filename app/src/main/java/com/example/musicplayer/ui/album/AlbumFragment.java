...
public class AlbumFragment extends Fragment implements AlbumAdapter.AlbumAdapterCallback, MediaOptionsAdapter.MediaOptionsAdapterListener {
    ...
    private AlbumFragmentCallback albumFragmentCallback;
    ...
    public interface AlbumFragmentCallback{
        void onPlayAlbumListener(ArrayList<MusicResolver> albumTrackList, boolean shuffle);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try{
            albumFragmentCallback = (AlbumFragmentCallback) context;
        ...
        albumViewModel.getAllAlbumSongs(resolver.getAlbumId()).observe(getViewLifecycleOwner(), albumTrackList -> {
            switch (action){
                case AlbumOptions.OPTION_PLAY:{
                    albumFragmentCallback.onPlayAlbumListener(albumTrackList, false);
                    break;
                }
                case AlbumOptions.OPTION_SHUFFLE:{
                    albumFragmentCallback.onPlayAlbumListener(albumTrackList, true);
                    break;
                }
                case AlbumOptions.OPTION_QUEUE:{
                    albumFragmentCallback.onQueueAlbumListener(albumTrackList);
                    break;
                }
            }
        });
